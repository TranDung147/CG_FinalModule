...
public interface IEmployeeRepository extends JpaRepository<Employee, Integer> {
    @Query("SELECT u FROM Employee u WHERE " +
            ...
            "OR u.employeePhone LIKE CONCAT('%', :keyword, '%') OR LOWER(u.employeePosition) LIKE LOWER(CONCAT('%', :keyword, '%')))) " +
            ...
            "OR (:type = 'employeeWork' AND LOWER(u.employeePosition) LIKE LOWER(CONCAT('%', :keyword, '%')))")
